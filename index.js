      ...
      checkReady(function($) {
          $(function() {
            ...
            setTimeout(function () {
              ...
              $("#add-to-basket-btn").text("Hello world!");

            }, 2000);


            setInterval(function() {
            //   if(!$('.tab-content.expanded .col-lg-10').hasClass('col-lg-12')){
            //     $('.tab-content.expanded .col-lg-10').addClass('col-lg-12').removeClass('col-lg-10');
            //  }
            });
          });
      });
